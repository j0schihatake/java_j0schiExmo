...
public class Main {
    ...
    //D:\Develop\Java\Projects\Биржа\J0schiExmo\src\main\java\j0schiExmo.Main.java

    private static final String HMAC_SHA512 = "HmacSHA512";

    public static void main(String[] args) {
        //publicApiUsageExample();
        privateApiUsageExample();
    }
    ...
    public static void privateApiUsageExample() {
        WebSocketClient ws = null;
        try {
            final String apiKey = "K-1df6ff5bb5f5df3bd78f0b3b210f2eface12090f";
            final String secretKey = "S-96c66b8c5d81a59784494971c30c52cba440fb81";
